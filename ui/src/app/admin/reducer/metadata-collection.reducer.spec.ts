import { reducer } from './metadata-collection.reducer';
import * as fromCollection from './metadata-collection.reducer';
import * as resolverActions from '../action/metadata-collection.action';
...
describe('Resolver Reducer', () => {
    ...
    describe('Load Providers: Success', () => {
        it('should add the loaded resolvers to the collection', () => {
            const action = new resolverActions.LoadMetadataSuccess(resolvers);
    ...
    describe('Update Providers: Success', () => {
        it('should update the draft of the specified id', () => {
            ...
            const action = new resolverActions.UpdateMetadataSuccess({ id: changes.id, changes });
